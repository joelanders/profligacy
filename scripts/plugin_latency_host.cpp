...
{
	if (argc != 12) {
		std::fprintf(stderr, "usage: latency_host PLUGIN OUTPUT_PREFIX RATE BLOCK SECONDS REPREPARE_SECONDS fixed|variable OFFLINE_AFTER_SECONDS fast|paced|prefetch REALTIME_AFTER_SECONDS MIDI_FILE\n");
        return 2;
    }
